package idzassignment.controller;
...
import idzassignment.entity.Employee;
import idzassignment.response.ResponseApi;
import idzassignment.service.UserService;
...
public class controller {
	...
	public String removeEmployee(@PathVariable(value = "id") int id, Model model) {
